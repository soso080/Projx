...
#
# # =====================================================================
# # ATTENTION: TOUT LE CODE CI-DESSOUS EST DÉPRÉCIÉ ET N'EST PLUS UTILISÉ
# # Il a été refactorisé selon l'architecture MVC et déplacé dans les
# # contrôleurs appropriés. Il est conservé ici uniquement pour référence.
# #
# # NOTE: Ce code ne sera pas exécuté car la variable 'app' a été redéfinie
# # et les imports nécessaires ont été supprimés.
# # =====================================================================
#
# # @app.route('/signUp')
# def signUp():
